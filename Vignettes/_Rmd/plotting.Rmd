...
Besides, package **tripack**, and package **latticist** are mentioned, but not used in this vignette.
...
# FIXME: grammatical structure of these sentences are difficult to understand.
