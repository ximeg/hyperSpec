...
```{r plotspc, fig = TRUE, width = 4, height = 2.6, include = FALSE }
plotspc (flu)
```
...
```{r plotmat-flu, fig = TRUE, width = 4, height = 2.6, include = FALSE }
plotmat (flu)
```
...
```{r plotflu, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotc (flu)
```
Fig. \@ref(fig:levelplot) "levelplot" 
  plots a false colour map, defined by a formula.

```{r levelplot, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmap, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotmap (chondro)
```
...
```{r voronoi, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotspcflu, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plot (flu, "spc")
```
Fig. \@ref(fig:plotchomean) "plot (x, "spcmeansd")" 
plots mean spectrum $\pm$ 1 standard deviation

```{r plotchomean, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotts, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plot (laser [,, 405], "ts")
```
...
```{r plotdepth, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmat, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plot (laser, "mat")
```
Equivalent to 
...
```{r plotmapcho2, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plot (chondro, "map")
```
Fig. \@ref(fig:plotvoronoi) "plot (x, "voronoi")" 

```{r plotvoronoi, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r wavelength, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r wavelength-2, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotspc (paracetamol, 
...
```{r mass, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plot (barbiturates [[1]], lines.args = list (type = "h"))
```
Fig. \@ref(fig:add) "more spectra into an existing plot" 
use `add = TRUE`{.r}

```{r add, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotspc (chondro [ 30,,])
...
```{r sd, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r diffline, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotspc (paracetamol, 
...
```{r add-line, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r stacked1, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r stacked2, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plot (cluster.meansd, 
      stacked = ".aggregate",
      fill = ".aggregate",
      col = cluster.cols)
...
```{r stacked3, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r stacked4, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r stacked5, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r lin-cal-1, fig = TRUE, width = 4, height = 2.6,include = FALSE}
plotc (flu [,, 450])
```
...
```{r lin-cal-3, fig = TRUE, width = 4, height = 2.6,include = FALSE}
...
```{r plotc2, fig = TRUE, width = 4, height = 2.6,include = FALSE}
...
```{r plotc3, fig = TRUE, width = 4, height = 2.6,include = FALSE}
...
```{r lin-cal-4, fig = TRUE, width = 4, height = 2.6,include = FALSE}
plotc (flu [,, 450], 
...
```{r lin-cal-5, fig = TRUE, width = 4, height = 2.6,include = FALSE}
...
```{r plotc4, fig = TRUE, width = 4, height = 2.6,include = FALSE}
...
```{r levelplot-factor, fig = TRUE, width = 4, height = 2.6,include = FALSE}
...
```{r plotmat2, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmap-barb, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmap-chondro, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotmap (chondro)
```
...
```{r plotmap-yx, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotmap (chondro, spc ~ y * x)
```
Fig. \@ref(fig:plotmap-clu) "colour-coded factors" 

```{r plotmap-clu, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmap-col, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotmap (chondro, clusters ~ x * y,
...
```{r plotmap-col-default, fig = TRUE, width = 4, height = 2.6, include = FALSE }
...
```{r lattice-settings, fig = TRUE, width = 8, height = 6, include = FALSE, echo = FALSE }
...
```{r plotmap-wave, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmap-pca, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotmap (chondro, 
         spc ~ y * x | x > 5, 
...
```{r plotmap-pca2, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r plotmap-pca3, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r voronoi-2, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotvoronoi (sample (chondro, 300), clusters ~ x * y, 
             col.regions = matlab.palette(20))
```
%
...
```{r missing, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r uneven-I, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotmap (uneven)
```
...
```{r uneven-II, fig = TRUE, width = 4, height = 2.6,include = FALSE }
plotvoronoi (uneven)
```
...
```{r uneven-III, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r uneven-IV, fig = TRUE, width = 4, height = 2.6,include = FALSE }
...
```{r rgl-plot, eval = FALSE}  evaluation in rgl-do
